...
<div class="container">
	...
	<div id="form_show" style="display:none">
		<table style="margin:0 auto;">
			<tr>
				<td><input type="text" name="username" placeholder="Username or Email" class="forminput"></td>
			</tr>
			<tr>
				<td><input type="password" name="password" placeholder="Password" class="forminput"></td>
			</tr>
			<tr>
				<td><input type="submit" name="submit" class="button_login" value="Login"></td>
			</tr>
		</table>
	</div>
</div>
